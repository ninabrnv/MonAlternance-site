...
/* alt_annonces.html */
class __TwigTemplate_6e12a35056c890d536da0c79d61f92e6bdf2b17311fb2ce64c8eb51895756b88 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $this->loadTemplate("overall_header.html", "alt_annonces.html", 1)->display($context);
        if ($namespace) {
...
<div class=\"container-fluid mb-5\">
    ...
    <div class=\"row\">
        ...
        if (($context["affiche_carte"] ?? null)) {
            ...
            $this->loadTemplate("alt_accueil_map.html", "alt_annonces.html", 337)->display($context);
            if ($namespace) {
                $this->env->setNamespaceLookUpOrder($previous_look_up_order);
            }
            // line 338
...
";
        ...
        $this->loadTemplate("overall_footer.html", "alt_annonces.html", 496)->display($context);
        if ($namespace) {
            $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        }
    }
    ...
    {
        return new Twig_Source("", "alt_annonces.html", "");
    }
}
