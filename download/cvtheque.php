...
if (($userProfilAlt['date_acces_cvtheque'] == '')  || strtotime($userProfilAlt['date_acces_cvtheque']) < strtotime("now") )  {
    redirect(append_sid($phpbb_root_path . "cvtheque-offres.$phpEx", ''));
    die;
}


$page_title = "Administration - CVthèque";
...
if ($filtreNom != '')
    ...
    //echo "<br><br><br><br><br><br><br><br><br><br><br><br><br><br> sql = " . $sql;
...
$template->assign_vars(array(
    ...
    'ALT_SCRIPT_PAGE' =>   '<script src="assets/javascript/alt_admin_cvtheque.js"></script>',
    'ville1'    => $ville1,
    'domaine'   => $domaine,
    'domaine_artisanat'   => $domaine_artisanat,
    'display_domaine_artisanat' => ($domaine === 'ARTISANAT') ? '' : 'none'
));
*/
