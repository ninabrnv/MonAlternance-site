...
if ($user->data['is_registered']) {
   ...
   // echo "<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>email : " . print_r($user->data);
    ...
    ville,ville_proche,	date_naissance,	domaine_principal, domaine_artisanat,	niveau_etude,	derniere_ecole,
    ...
    $template->assign_vars(array(
        ...
        'ACTION_COMPTE_SUPPRIMER' => append_sid("{$phpbb_root_path}indcompteex.$phpEx?onglet=moncompte&action=compteSupprimer", ''),
