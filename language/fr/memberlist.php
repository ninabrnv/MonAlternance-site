...
$lang = array_merge($lang, [
	...
	'CC_SENDER'     => 'M’envoyer une copie de cet email.',
	'CONTACT_ADMIN' => 'Contacter un administrateur',
	...
	'EMAIL_BODY_EXPLAIN'  => 'L’adresse de retour du message correspond à votre adresse email.',
	...
	'EMAIL_TOPIC_EXPLAIN' => 'Le message sera envoyé en texte brut, sans balise HTML ou BBCode. Veuillez noter que le contenu du sujet est déjà intégré au message. L’adresse de retour du message correspond à votre adresse d email.',
	'EMPTY_ADDRESS_EMAIL' => 'Vous devez saisir une adresse d’email valide concernant le destinataire.',
	'EMPTY_MESSAGE_EMAIL' => 'Vous devez saisir un message afin d’envoyer un email.',
	'EMPTY_MESSAGE_IM'    => 'Vous devez saisir le contenu du message.',
	'EMPTY_NAME_EMAIL'    => 'Vous devez saisir le nom réel du destinataire.',
	'EMPTY_SENDER_EMAIL'  => 'Vous devez saisir une adresse d’email valide.',
	'EMPTY_SENDER_NAME'   => 'Vous devez spécifier un nom.',
	'EMPTY_SUBJECT_EMAIL' => 'Vous devez saisir le sujet de l’email.',
	'EQUAL_TO'            => 'Égal à',
	...
	'FLOOD_EMAIL_LIMIT'     => 'Vous ne pouvez pas envoyer d’autres emails pour le moment. Veuillez réessayer ultérieurement.',
	...
	'IM_NO_JABBER'      => 'La transmission de messages instantanés vers des utilisateurs de Jabber n’est pas prise en charge sur ce site. Vous devez installer un client Jabber sur votre système afin de contacter le destinataire ci-dessus.',
	...
	'NO_CONTACT_FORM' => 'Le formulaire de contact des administrateurs du site a été désactivé.',
	'NO_CONTACT_PAGE' => 'La page de contact des administrateurs du site a été désactivée.',
	'NO_EMAIL'        => 'Vous ne pouvez pas envoyer d email à cet utilisateur.',
	...
	'SENDER_EMAIL_ADDRESS' => 'Votre adresse de email',
	...
	'USER_PRESENCE'  => 'Présence sur le site',
