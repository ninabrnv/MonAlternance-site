...
$lang = array_merge($lang, [
	...
	'ACP_SHORT'                                          => 'PCA',
	'ACTIVE'                                             => 'actif',
	'ACTIVE_ERROR'                                       => 'Le nom d’utilisateur que vous avez spécifié est actuellement inactif. Si vous rencontrez des difficultés lors de l’activation de votre compte, veuillez contacter un administrateur.',
	...
	'BOARD_BAN_PERM'         => 'Vous avez été définitivement banni de ce site.<br /><br />Pour plus d’informations, veuillez contacter un %2$sadministrateur%3$s.',
	'BOARD_BAN_REASON'       => 'Raison du bannissement : %s',
	'BOARD_BAN_TIME'         => 'Vous avez été banni de ce site jusqu’au %1$s.<br /><br />Pour plus d’informations, veuillez contacter un %2$sadministrateur%3$s.',
	'BOARD_DISABLE'          => 'Le site est actuellement indisponible.',
	'BOARD_DISABLED'         => 'Le site est actuellement désactivé.',
	'BOARD_UNAVAILABLE'      => 'Le site est temporairement indisponible. Veuillez revenir ultérieurement.',
	...
	'CHANGING_PREFERENCES' => 'Modifie les préférences du site',
	...
	'COOKIES_DELETED'       => 'Les cookies du site ont été supprimés.',
	...
	'DELETE_COOKIES'   => 'Supprimer tous les cookies du site',
	...
	'LOGIN_ERROR_PASSWORD'                     => 'Le mot de passe que vous avez spécifié est incorrect. Veuillez vérifier votre mot de passe et réessayer. Si ce problème persiste, veuillez contacter un %sadministrateur du site%s.',
	'LOGIN_ERROR_PASSWORD_CONVERT'             => 'Il n’a pas été possible de convertir votre mot de passe lors de la mise à jour du logiciel de ce site de discussions. Veuillez %sdemander un nouveau mot de passe%s. Si ce problème persiste, veuillez contacter un %sadministrateur du site%s.',
	'LOGIN_ERROR_USERNAME'                     => 'Le nom d’utilisateur que vous avez spécifié est incorrect. Veuillez vérifier votre nom d’utilisateur et réessayer. Si ce problème persiste, veuillez contacter un %sadministrateur du site%s.',
	'LOGIN_FORUM'                              => 'Vous devez saisir le mot de passe de ce site afin de consulter et de publier des sujets et des messages.',
	'LOGIN_INFO'                               => 'Vous devez être inscrit avant de pouvoir vous connecter. L’inscription est rapide et vous offre de nombreux avantages. Les administrateurs du site peuvent accorder des fonctionnalités supplémentaires aux utilisateurs inscrits. Avant de vous inscrire, assurez-vous d’avoir pris connaissance de nos conditions d’utilisation et de notre politique de confidentialité. Veuillez également prendre le temps de consulter attentivement toutes les règles du site lors de votre navigation.',
	'LOGIN_VIEWFORUM'                          => 'Vous devez être inscrit et connecté afin de pouvoir consulter ce site.',
	'LOGIN_EXPLAIN_EDIT'                       => 'Vous devez être inscrit et connecté afin de pouvoir modifier les messages de ce site.',
	...
	'MCP_SHORT'           => 'PCM',
	'MEMBERLIST'          => 'Membres',
	'MEMBERLIST_EXPLAIN'  => 'La liste complète des membres du site',
	'MERGE'               => 'Fusionner',
	...
	'NOTIFY_ADMIN'              => 'Veuillez contacter un administrateur du site.',
	'NOTIFY_ADMIN_EMAIL'        => 'Veuillez contacter un administrateur du site: <a href="mailto:%1$s">%1$s</a>',
	...
	'RETURN_TO_INDEX'          => 'Revenir à l’accueil du site',
	'FEED'                     => 'Flux',
	...
	'SEND_EMAIL'               => 'Envoyer un email', // Used for submit buttons
	'SEND_EMAIL_USER'          => 'Envoyer un email à %s',
	...
	'SQL_ERROR_OCCURRED'       => 'Une erreur SQL est survenue lors du chargement de la page. Si ce problème persiste, veuillez contacter un %sadministrateur du site%s.',
	'STATISTICS'               => 'Statistiques',
	'START_WATCHING_FORUM'     => 'S’abonner au forum',
	'START_WATCHING_TOPIC'     => 'S’abonner au sujet',
	'STOP_WATCHING_FORUM'      => 'Se désabonner du site',
	...
	'WELCOME_SUBJECT'      => 'Bienvenue sur le site %s',
