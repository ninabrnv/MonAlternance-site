...
function page_header($page_title = '', $display_online_list = false, $item_id = 0, $item = 'forum', $send_headers = true)
{
	...
	*/
	...
	// ALT : indique si on est en mode production ou non. Si production, on met en place Google analytics etc
	if (defined('ALT_LOCAL'))
	{
		$template->assign_vars(array(
			'ALT_LOCAL' => true
		));
	...
	$template->assign_vars(array(
		...
		'U_SITE_HOME'			=> append_sid("{$phpbb_root_path}index.$phpEx"), //fv $config['site_home_url'],
		...
		'U_ALT_AJAX' => append_sid("{$phpbb_root_path}ajax.$phpEx", ''),

		'U_ALT_ACTUALITE_REFORME' => append_sid("{$phpbb_root_path}rupture-du-contrat-d-apprentissage.$phpEx?t=1", ''),
		'U_ALT_ACTUALITE_RUPTURE' => append_sid("{$phpbb_root_path}rupture-du-contrat-de-professionnalisation.$phpEx?t=2", ''),
		

		'U_ALT_CGU'				=> append_sid("{$phpbb_root_path}cgu.$phpEx", ''),
		
		'U_ALT_MENTIONS'	=> append_sid("{$phpbb_root_path}mentions.$phpEx", ''),
		
		'U_ALT_CANDIDATS_SALAIRES' => append_sid("{$phpbb_root_path}candidats-les-salaires-en-alternance.$phpEx", ''),
		'U_ALT_CANDIDATS_CONTRATS' => append_sid("{$phpbb_root_path}candidats-les-contrats-en-alternance.$phpEx", ''),
		'U_ALT_CANDIDATS_DIPLOMES' => append_sid("{$phpbb_root_path}candidats-les-diplomes-en-alternance.$phpEx", ''),
		'U_ALT_CANDIDATS_STAGES' => append_sid("{$phpbb_root_path}candidats-les-stages-en-entreprises.$phpEx", ''),
		'U_ALT_CONTACT' => append_sid("{$phpbb_root_path}contact.$phpEx", ''),
		'U_ALT_CREDIT' => append_sid("{$phpbb_root_path}credit.$phpEx", ''),
		'U_ALT_CVTHEQUE' => append_sid("{$phpbb_root_path}cvtheque.$phpEx", ''),
		'U_ALT_CVTHEQUE_OFFRES' => append_sid("{$phpbb_root_path}cvtheque-offres.$phpEx", ''),
		'U_ALT_ENTREPRISES_AIDE_AUX_TPE' => append_sid("{$phpbb_root_path}entreprises-aide-aux-tpe.$phpEx", ''),
		'U_ALT_ENTREPRISES_AIDE_A_APPRENTISSAGE' => append_sid("{$phpbb_root_path}entreprises-aide-a-apprentissage.$phpEx", ''),
		
		'U_ALT_LA_REFORME' => append_sid("{$phpbb_root_path}la-reforme-en-faveur-de-l-alternance.$phpEx", ''),
		'U_ALT_ARTICLE_TROUVER_FORMATION' => append_sid("{$phpbb_root_path}trouver-sa-formation-en-alternance.$phpEx", ''),
		'U_ALT_ARTICLE_DECLARATION_REVENUS' => append_sid("{$phpbb_root_path}declaration-revenus-en-alternance.$phpEx", ''),
		'U_ALT_ARTICLE_TRAVAILLER_ET_ECOLE' => append_sid("{$phpbb_root_path}travailler-et-etre-a-l-ecole.$phpEx", ''),
		'U_ALT_ARTICLE_ALTERNANCE_A_30_ANS' => append_sid("{$phpbb_root_path}alternance-a-30-ans.$phpEx", ''),

		'U_ALT_ARTICLE_ALTERNANCE_10_BONNES_RAISONS' => append_sid("{$phpbb_root_path}alternance-en-10-bonnes-raisons.$phpEx", ''),
		'U_ALT_ARTICLE_RECRUTER_JEUNE_ALTERNANCE' => append_sid("{$phpbb_root_path}recruter-jeune-en-alternance.$phpEx", ''),
		'U_ALT_ARTICLE_ALTERNANCE_VOIX_REUSSITE' => append_sid("{$phpbb_root_path}alternance-voix-de-reussite.$phpEx", ''),
		

		'U_ALT_MES_ANNONCES'			=> append_sid("{$phpbb_root_path}compte.$phpEx?onglet=mesannonces", ''),
		'U_ALT_MES_CV'			=> append_sid("{$phpbb_root_path}compte.$phpEx?onglet=mescv", ''),
		
		'U_ALT_MES_FAVORIS'			=> append_sid("{$phpbb_root_path}compte.$phpEx?onglet=mesfavoris", ''),
		'U_ALT_MON_COMPTE'			=> append_sid("{$phpbb_root_path}compte.$phpEx?onglet=moncompte", ''),
		'U_ALT_MON_PROFIL'			=> append_sid("{$phpbb_root_path}compte.$phpEx?onglet=monprofil", ''),
		'U_ALT_PROFIL'			=> append_sid("{$phpbb_root_path}profil.$phpEx", ''),
		'U_ALT_RECRUTEURS'		=> append_sid("{$phpbb_root_path}recruteurs.$phpEx", ''),

		'U_ANNONCES_RECHERCHE' => append_sid("{$phpbb_root_path}annonces.$phpEx", ''),

		'U_ALT_EMPLOIS' => append_sid("{$phpbb_root_path}emplois.$phpEx", ''),
		...
		'U_ALT_OFFRES_ALTERNANCE_DIJON' => append_sid("{$phpbb_root_path}offres-alternance-dijon.$phpEx", ''),
		...
		'U_ALT_OFFRES_ALTERNANCE_TOURS' => append_sid("{$phpbb_root_path}offres-alternance-tours.$phpEx", ''),

		'IMAGE_LOGO_MON_ALTERNANCE' => defined('PAGE_ACCUEIL') ? 'logo-entier-60px.gif' : 'logo-entier-60px.gif',

		'U_USER_ADMIN'			=> ($auth->acl_get('a_user')) ? append_sid("{$phpbb_admin_path}index.$phpEx", 'i=users&amp;mode=overview&amp;u=' . $user_id, true, $user->session_id) : '',
		'U_ALT_MODERATEUR'		=> $userProfilAlt['is_admin'] === 'true' ? append_sid("{$phpbb_root_path}admin.$phpEx", '') : '',

		'U_ALT_ADMIN_ENTREPRISES' => append_sid("{$phpbb_root_path}admin-entreprises.$phpEx", ''),
		'U_ALT_ADMIN_CANDIDATS' => append_sid("{$phpbb_root_path}admin-candidats.$phpEx", ''),
		'U_ALT_ADMIN_ADMINS' => append_sid("{$phpbb_root_path}admin-admins.$phpEx", ''),

		'U_ALT_ADMIN_ANNONCES' => append_sid("{$phpbb_root_path}admin-annonces.$phpEx", ''),
		'U_ALT_ADMIN_CANDIDATURES' => append_sid("{$phpbb_root_path}admin-candidatures.$phpEx", ''),
		'U_ALT_ADMIN_PAIEMENTS' => append_sid("{$phpbb_root_path}admin-paiements.$phpEx", ''),
		'U_ALT_ADMIN_CVTHEQUE' => append_sid("{$phpbb_root_path}admin-cvtheque.$phpEx", ''),
		...
		'user_email_or_nomprenom' => ($userProfilAlt['type_compte'] === 'entreprise') ? $userProfilAlt['societe_nom'] : $userProfilAlt['prenom'] . ' ' .$userProfilAlt['nom'],

		'TYPE_COMPTE_CANDIDAT' => ($userProfilAlt['type_compte'] === 'candidat') ? true : false,
